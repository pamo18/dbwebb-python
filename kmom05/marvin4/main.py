...
while True:
    ...
    print("q) Quit (Scared!?)")
    print("Ask me for a quote, about lunch or your rucksack contents if you want!")
    ...
    elif "inv drop" in choice and not choice == "inv drop":
        ivm.inv_drop(choice)
        time.sleep(1)
        continue
    ...
    while True:
        ...
        elif "inv pick" in option:
            ivm.inv_pick(option)
            time.sleep(1)
            print("\n")
            continue

        elif "inv drop" in option and not option == "inv drop":
            ivm.inv_drop(option)
            time.sleep(1)
            print("\n")
            continue

        elif option == "inv drop":
            ivm.inv_drop_all()
            print("\n")
            continue
